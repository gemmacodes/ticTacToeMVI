...
import com.sps.tictactoe.TicTacToeFeature2p.*
import com.sps.tictactoe.TicTacToeFeature2p.Effect.*
import com.sps.tictactoe.TicTacToeFeature2p.State.GameStatus.*
import com.sps.tictactoe.TicTacToeFeature2p.Wish.MakeMove
import com.sps.tictactoe.TicTacToeFeature2p.Wish.ResetGame
import com.sps.tictactoe.TicTacToeVM.GameCounter
import com.sps.tictactoe.TicTacToeVM.PlayedBy
import com.sps.tictactoe.TicTacToeVM.PlayedBy.*
import io.reactivex.Observable

class TicTacToeFeature2p : BaseFeature<Wish, Action, Effect, State, News>(
    initialState = State(),
    reducer = ReducerImpl(),
